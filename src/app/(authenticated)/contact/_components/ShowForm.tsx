...
const ShowForm = ({
  ...
  return (
    <>
      <div className="shadow-lg bg-white h-16 mb-4 rounded-md flex items-center">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg w-full ">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <Input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 bg-gray-200"
            />
            <Input
              label="Email Address"
              name="email"
